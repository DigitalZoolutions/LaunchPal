...
namespace LaunchPal.ExternalApi.PeopleInSpace.Request
{
    internal static class HttpCaller
    {
        ...
        internal static async Task<T> CallLaunchLibraryApi<T>(string url) where T : PeopleBase
        {
            // The API call
            T result = null;
            using (var client = new HttpClient())
            {
                ...
                client.BaseAddress = new Uri("http://www.howmanypeopleareinspacerightnow.com/peopleinspace.json");
